      ...
      <div className="container-custom">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4 text-text/80 text-sm sm:text-base">
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-text/70 font-medium text-xs sm:text-sm md:text-base">{stat.label}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
