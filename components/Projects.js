  ...
  return (
    <section id="projects" className="section-padding bg-white">
      ...
      >
        ...
        >
          <a href="/projects" className="btn-secondary inline-block">View All Projects</a>
        </motion.div>
      </motion.div>
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="absolute inset-0 bg-gradient-to-r from-accent/10 to-primary/10 rounded-xl pointer-events-none"
              />

              {/* Lightweight particles rising from the top of the modal */}
              <div className="pointer-events-none absolute top-0 left-0 right-0 h-40 overflow-visible">
                {[...Array(8)].map((_, i) => (
                  <motion.span
                    key={i}
                ...
                >
                  {[
                    ...
                    >
                      ...
                      <p className="text-text/90 text-justify text-sm">{section.content}</p>
                    </motion.div>
                  ))}
                </motion.div>
                ...
                >
                  {activeProject.githubUrl && (
                    <motion.a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-accent text-accent hover:bg-accent hover:text-white transition-all duration-300"
                    >
                  ...
                  <motion.button 
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={() => setActiveProject(null)} 
                    className="inline-flex items-center px-4 py-2 rounded-lg bg-accent text-white hover:opacity-90 transition-all duration-300"
                  >
                    Close
                  </motion.button>
                </motion.div>
